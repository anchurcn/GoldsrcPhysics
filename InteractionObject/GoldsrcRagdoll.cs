...
//    unsafe class GoldsrcRagdoll : IGoldsrcBehaviour
//    {
...
//            OriginalStudioParentTransformsInverse = new Matrix[(int)BodyPart.Count];
//            for (int i = 1; i < (int)BodyPart.Count; i++)
//            {
...
//                var rotation = relativedTransf.DecomQuat();
//                //赋值
//                StudioQuaternions[IndexBodyPart[i].Item1] = rotation;
//            }
//            result = BRagdoll._bodies[(int)BodyPart.Pelvis].WorldTransform * OriginalInverseTransforms[0];
//            StudioQuaternions[1] = result.DecomQuat()*StudioQuaternions[1];
//            var origOffset = result.Origin;
